  ...
  return (
    <div className="mx-auto !p-5 h-screen min-vh-100 overflow-auto bg-[#f0f0f0]">
      <div className="h-full flex fex-row items-center justify-center">
        <div className='h-1/4 w-full md:w-2/4 md:h-2/4 bg-white px-2.5 py-2.5 rounded-md shadow-xl'>
          <div
            style={{ height: "20%" }}
          ...
          <div style={{ height: "70%"}} className='overflow-auto flex justify-center'>{action_form}</div>
          <div
            style={{ height: "10%" }}
            className="flex fex-row items-center justify-center"
          >
