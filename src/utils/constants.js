...
export const PRODUCT_SUBCATEGORY = {
    ...
    "F&B": [
        {value: 'Continental', key: 'Continental', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Middle Eastern', key: 'Middle Eastern', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'North Indian', key: 'North Indian', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Pan-Asian', key: 'Pan-Asian', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Regional Indian', key: 'Regional Indian', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'South Indian', key: 'South Indian', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Tex-Mexican', key: 'Tex-Mexican', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'World Cuisines', key: 'World Cuisines', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Healthy Food', key: 'Healthy Food', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Fast Food', key: 'Fast Food', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Desserts', key: 'Desserts', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Bakes & Cakes', key: 'Bakes & Cakes', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
        {value: 'Beverages (MTO)', key: 'Beverages (MTO)', protocolKey: '@ondc/org/mandatory_reqs_veggies_fruits'},
    ],
    "Electronics": [
